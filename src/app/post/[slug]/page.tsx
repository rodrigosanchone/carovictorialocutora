...
import AsideTags from "@/components/AsideTags"; // 👈 Importa el componente
...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      url: `https://carovictorialocutoralocutora.com/post/${params.slug}`,
...
export default async function PostPage({ params }: PageProps) {
  try {
    ...
    const fecha = post?.createdAt?.seconds
      ? new Date(post.createdAt.seconds * 1000).toLocaleDateString("es-CR", {
          year: "numeric",
          month: "long",
          day: "numeric",
        })
      ...
      <div className="max-w-6xl mx-auto px-4 py-16 grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-12">
        <article>
          ...
          <div className="mt-10 flex gap-6 justify-center text-gray-600 dark:text-gray-300">
            ...
            <a
              href={`https://twitter.com/intent/tweet?url=https://carovictorialocutora.com/post/${
                params.slug
